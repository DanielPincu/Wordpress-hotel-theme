...
// Template Name: Standard Room Template
        ...
        <div class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="5000">
                        <img src="<?php echo $pic1 ?>" class="d-block w-100" alt="Picture of room">
                    </div>
                    <div class="carousel-item" data-bs-interval="5000">
                        <img src="<?php echo $pic2 ?>" class="d-block w-100" alt="Picture of room">
                    </div>
                </div>
            </div>
